...
@Log4j2
public class PumpInformationDataVo extends PumpInformationData {
	private static final long serialVersionUID = 1L;
	private ObjectNode pvJson;

	public PumpInformationData convert() {
		var t = new PumpInformationData();
		BeanUtils.copyProperties(this, t);
		t.setPvDesc(this.getPvJson().toString());
		return t;
	}

	public static PumpInformationDataVo convert(ObjectMapper mapper, PumpInformationData item) {
		var t = new PumpInformationDataVo();
