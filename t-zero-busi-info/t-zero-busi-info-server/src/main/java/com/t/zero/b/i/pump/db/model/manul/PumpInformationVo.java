...
@Log4j2
public class PumpInformationVo extends PumpInformation {
	private static final long serialVersionUID = 1L;
	private ObjectNode pvJson;

	public PumpInformation convert() {
		var t = new PumpInformation();
		BeanUtils.copyProperties(this, t);
		t.setPvDesc(this.getPvJson().toString());
		return t;
	}

	public static PumpInformationVo convert(ObjectMapper mapper, PumpInformation item) {
		var t = new PumpInformationVo();
