...
@Log4j2
public class PumpMaterialInfoVo extends PumpMaterialInfo {
	private static final long serialVersionUID = 1L;
	private ObjectNode pvJson;

	public PumpMaterialInfo convert() {
		var t = new PumpMaterialInfo();
		BeanUtils.copyProperties(this, t);
		t.setPvDesc(this.getPvJson().toString());
		return t;
	}

	public static PumpMaterialInfoVo convert(ObjectMapper mapper, PumpMaterialInfo item) {
		var t = new PumpMaterialInfoVo();
