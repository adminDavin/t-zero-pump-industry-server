...
import com.t.zero.b.i.pump.service.PumpMaterialInfoService;
...
@RestController
@RequestMapping("/pump_material_info")
public class PumpMaterialInfoController extends TZeroBasicController {
	private final PumpMaterialInfoService pumpAttributesService;

	public PumpMaterialInfoController(ResponseExceptionHandler responseExceptionHandler, PumpMaterialInfoService pumpAttributesService) {
