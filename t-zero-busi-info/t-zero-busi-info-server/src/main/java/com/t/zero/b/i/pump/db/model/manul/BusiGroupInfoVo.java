...
@Log4j2
public class BusiGroupInfoVo extends BusiGroupInfo {
	private static final long serialVersionUID = 1L;
	private ObjectNode pvJson;

	public BusiGroupInfo convert() {
		var t = new BusiGroupInfo();
		BeanUtils.copyProperties(this, t);
		t.setPvDesc(this.getPvJson().toString());
		return t;
	}
	
	public static BusiGroupInfoVo build(ObjectMapper mapper) {
		var i = new BusiGroupInfoVo();
		i.pvJson = mapper.createObjectNode();
		return i;
	}

	public static BusiGroupInfoVo convert(ObjectMapper mapper, BusiGroupInfo item) {
		var t = new BusiGroupInfoVo();
