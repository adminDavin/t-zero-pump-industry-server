...
import com.t.zero.b.i.pump.service.PumpAttributesService;
...
@RestController
@RequestMapping("/pump_attributes")
public class PumpAttributesCnotroller extends TZeroBasicController {
	private final PumpAttributesService pumpAttributesService;

	public PumpAttributesCnotroller(ResponseExceptionHandler responseExceptionHandler, PumpAttributesService pumpAttributesService) {
