...
ACTIONS=("upgrade")
ERROR_CODE=1
T_ZERO_OPTS="-DappName=t-zero-message-platform"
...
startup() {
    ...
    nohup java $JAVA_OPTS $JAVA_DEBUG_OPT -classpath .:$CLASSPATH com.t.zero.message.platform.MessagePlatformApplication $1 $2 2>&1 &
