package com.t.zero.basic.common.base.idgenerator;
...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
     ...
     * <p>
     * <p>
     * The 60 bit timestamp value is constructed from the time_low, time_mid, and time_hi fields of this {@code UUID}.
     * The resulting timestamp is measured in 100-nanosecond units since midnight, October 15, 1582 UTC.
     * <p>
     * <p>
     * The timestamp value is only meaningful in a time-based UUID, which has version type 1. If this {@code UUID} is
    ...
    private final static String LABEL_PREFIX = "#C-";

    /**
     *
     * @return A string, babel prefix + uuid(length 16)
     */
    public String toLabel(){
        return LABEL_PREFIX + (digits(mostSigBits >> 32, 8) + digits(mostSigBits >> 16, 4) + digits(mostSigBits, 4));
    }
     ...
     * true} if and only if the argument is not {@code null}, is a {@code UUID} object, has the same variant, and
     * contains the same value, bit for bit, as this {@code UUID}.
     *
     * @param obj
